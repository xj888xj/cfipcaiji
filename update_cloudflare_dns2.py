...
# 从环境变量中读取 Cloudflare API 参数
api_token = os.getenv("CLOUDFLARE_API_TOKEN")
zone_id = os.getenv("CLOUDFLARE_ZONE_ID")
subdomain = os.getenv("CLOUDFLARE_SUBDOMAIN2")
...
def download_ip_list(url, save_path):
    # 发送GET请求到URL
...
def add_dns_records(subdomain, save_path):
...
# 删除现有的DNS记录
delete_dns_records(subdomain)

# 定义文件URL和保存路径
url = "https://raw.githubusercontent.com/xj888xj/CFCDN-AutoYX/main/yx_ips.txt"
save_path = "bestcfip.csv"

# 下载IP地址列表
download_ip_list(url, save_path)

# 添加新的DNS记录
add_dns_records(subdomain, save_path)
